...
// Image
              ...
              Row(
                ...
                children: [
                  Column(
                    children: [
                      variable.text2("Rating ", 15.0, Colors.black, FontWeight.w200),
                      variable.text2("5.0", 15.0, Colors.black, FontWeight.normal),
                    ],
                  ),
                  Column(
                    children: [
                      variable.text2("Pages ", 15.0, Colors.black, FontWeight.w200),
                      variable.text2("220", 15.0, Colors.black, FontWeight.normal),
                    ],
                  ),
                  Column(
                    children: [
                      variable.text2("Time ", 15.0, Colors.black, FontWeight.w200),
                      variable.text2("5.73", 15.0, Colors.black, FontWeight.normal),
                    ],
                  ),
                ],
              ),
